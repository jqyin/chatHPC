...
from fastchat.model.model_chathpc import generate_stream_chathpc
...
def get_generate_stream_function(model: torch.nn.Module, model_path: str):
    ...
    if is_chatglm:
        ...
        return generate_stream_chathpc
...
register_model_adapter(ChatHPCAdapter)
