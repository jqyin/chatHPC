...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=lambda x: x.replace("forge-", ""),
        default="m2-final",
        choices=("llama2_7b","1.3b", "6.7b", "13b", "66b", "s4", "m2-final", "l-final", "m2-olcfdoc-200s"),
    ...
    parser.add_argument(
        ...
        type=lambda x: x.replace("facebook/opt-", ""),
        default="350m",
        choices=("350m", "llama2_7b", "forge-s4"),
...
def get_script(args, step_num):
    ...
    if 'llama2' in args.actor_model or 'llama2' in args.reward_model:
        model = 'llama2'
    elif 'forge' in args.actor_model or 'forge' in args.reward_model:
        model = 'forge'
    else:
        model = 'opt'
    model = 'forge'   
